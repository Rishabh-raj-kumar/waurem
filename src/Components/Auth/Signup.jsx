      ...
      <div class="mx-auto">
        <div class="flex justify-center px-6 py-12">
          <div class="w-full xl:w-3/4 lg:w-11/12 flex">
            ...
            >
              <a className="absolute bottom-2  left-4 text-sm mx-auto text-center" href="https://www.freepik.com/free-vector/zero-waste-concept-illustration_18151579.htm#fromView=search&term=illustation+reuse&track=ais&regularType=vector&page=1&position=2&uuid=bed3e24d-b519-4193-a253-b8106b116337">Image by storyset on Freepik</a>
            </div>
            <div class="w-full lg:w-7/12 bg-white dark:bg-gray-700 p-5 rounded-lg lg:rounded-l-none">
              ...
              <div className="flex flex-col items-center">
                ...
                <div class="text-center">
                  <Link className="text-slate-800 underline" to={'/auth/login'}>
